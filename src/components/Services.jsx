...
const services = [
  ...
  },
  {
    ...
    description:
      "Get expert guidance on IT strategy, compliance, and digital innovation to align technology with your business goals.",
  },
  {
    title: "Web & Business App Development",
    image: webAppImg,
    description:
      "We build responsive websites and robust business applications to streamline workflows and improve customer engagement.",
  },
];

export default function Services() {
  return (
    <section id="services" className="bg-gradient-to-br from-teal-300 via-white to-teal-100 py-24">
